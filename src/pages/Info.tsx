    ...
    <div className="min-h-screen bg-background text-text flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center px-6 pb-6">
        ...
        <div className="max-w-md md:max-w-lg space-y-4 md:space-y-5 text-text-secondary leading-relaxed text-center md:text-lg">
          <p>
            Привет! Я создал этот сайт, чтобы самому тренировать сербские слова
            до автоматизма. Когда переезжаешь в новую страну, важно быстро
            освоить базовую лексику, и я решил сделать инструмент, который
            поможет в этом.
          </p>
          ...
          <p>
            Функционал сайта будет расширяться: и я планирую добавить больше
            слов, новые режимы обучения и другие полезные фишки.
          </p>
          {/* <p>
        ...
        >
          <img
            src={getAssetPath("/icons/heart.svg")}
            alt=""
            className="h-5 w-5"
          />
          Оставить отзыв
